    ...
    <div className="max-w-md mx-auto min-h-screen bg-[#faf9f6] dark:bg-[#0b0f19] font-sans text-[#1a2e44] dark:text-slate-100 transition-colors duration-200" dir="rtl">
      ...
      <main className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          <a href="tel:02112345678" className="bg-white dark:bg-[#182234] p-5 rounded-[2rem] border border-gray-100 dark:border-slate-800 shadow-sm flex items-center justify-between hover:border-green-500 hover:shadow-md transition-all group">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-[#faf9f6] dark:bg-[#0b0f19] text-gray-500 dark:text-slate-400 rounded-2xl flex items-center justify-center group-hover:bg-green-50 dark:group-hover:bg-green-950/40 group-hover:text-green-500 transition-colors">
                <Phone size={24} />
              </div>
              <div>
                <span className="font-black text-[#1a2e44] dark:text-slate-100 block mb-1">تماس تلفنی</span>
                <span className="text-xs text-gray-400 dark:text-slate-400 font-bold" dir="ltr">021 - 1234 5678</span>
              </div>
            </div>
          </a>

          <a href="https://t.me/your_support" target="_blank" className="bg-white dark:bg-[#182234] p-5 rounded-[2rem] border border-gray-100 dark:border-slate-800 shadow-sm flex items-center justify-between hover:border-blue-500 hover:shadow-md transition-all group">
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="font-black text-[#1a2e44] dark:text-slate-100 block mb-1">پشتیبانی تلگرام</span>
                <span className="text-xs text-gray-400 dark:text-slate-400 font-bold" dir="ltr">@Support_Bot</span>
              </div>
            </div>
          </a>
