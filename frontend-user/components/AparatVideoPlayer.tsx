// frontend-user/components/AparatVideoPlayer.tsx
'use client';
...
export default function AparatVideoPlayer({ videoUrl, title }: AparatVideoPlayerProps) {
  ...
  const toggleFullscreen = async () => {
    ...
    if (!isFullscreen) {
      ...
      // اگر نیتیو مینی‌اپ مسدود بود، حالت Viewport Fullscreen (۱۰۰٪ ابعاد گوشی) فعال می‌شود
    ...
    <div
      ...
      className={`relative transition-all duration-300 ${
        isFullscreen
          ...
          : 'w-full rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 bg-black aspect-video mt-2 overflow-hidden group'
      }`}
      dir="rtl"
    >
