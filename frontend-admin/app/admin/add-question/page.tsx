      ...
      <header className="p-8 flex items-center justify-between sticky top-0 bg-[#faf9f6] dark:bg-[#182234] dark:bg-[#182234]/90 backdrop-blur-md z-20">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-400 dark:text-slate-400 dark:text-slate-400 text-xs font-bold mt-1">طراحی سوال جدید، تعیین گزینه‌های تستی و پاسخ صحیح</p>
          </div>
        </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6 px-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white dark:bg-[#182234] dark:bg-[#182234] p-6 rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-slate-800 dark:border-slate-800 space-y-4">
            <div>
              <label className="block text-[10px] font-black text-gray-400 dark:text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">متن صورت سوال</label>
              <textarea 
                required
                rows={4}
                className="w-full p-4 rounded-2xl bg-[#faf9f6] dark:bg-[#182234] dark:bg-[#182234] border-none focus:ring-2 focus:ring-[#c5a059] outline-none transition-all font-bold text-sm leading-relaxed"
            ...
            <div>
              <label className="block text-[10px] font-black text-gray-400 dark:text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-2">توضیحات یا راهنمایی (اختیاری)</label>
              <input 
                type="text"
                className="w-full p-4 rounded-2xl bg-[#faf9f6] dark:bg-[#182234] dark:bg-[#182234] border-none focus:ring-2 focus:ring-[#c5a059] outline-none transition-all font-bold text-sm"
          ...
          <div className="bg-white dark:bg-[#182234] dark:bg-[#182234] p-6 rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-slate-800 dark:border-slate-800 space-y-4">
             ...
             <div className="grid grid-cols-1 gap-3">
               {[1, 2, 3, 4].map((num) => (
                 <div key={num} className="flex items-center gap-4 bg-[#faf9f6] dark:bg-[#182234] dark:bg-[#182234] p-2.5 rounded-2xl border border-transparent focus-within:border-gray-200 dark:border-slate-800 dark:border-slate-800 transition-all">
                    <input 
                      type="radio" 
                      name="correct_option"
                      checked={formData.correct_option === num}
                      onChange={() => setFormData({...formData, correct_option: num})}
                      className="w-5 h-5 text-[#1a2e44] dark:text-slate-100 dark:text-slate-100 focus:ring-[#c5a059] cursor-pointer"
                    />
                    <input 
                      required
                      placeholder={`متن گزینه ${num}...`}
                      className="flex-1 p-2 bg-transparent border-none text-sm font-bold text-[#1a2e44] dark:text-slate-100 dark:text-slate-100 outline-none"
        ...
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="bg-white dark:bg-[#182234] dark:bg-[#182234] p-6 rounded-[2.5rem] shadow-sm border border-gray-100 dark:border-slate-800 dark:border-slate-800">
            <label className="block text-[10px] font-black text-gray-400 dark:text-slate-400 dark:text-slate-400 uppercase tracking-widest mb-3">انتخاب مسابقه هدف</label>
            <select 
              required
              className="w-full p-4 rounded-2xl bg-[#faf9f6] dark:bg-[#182234] dark:bg-[#182234] border-none focus:ring-2 focus:ring-[#c5a059] font-bold text-sm appearance-none outline-none"
            ...
            <p className="mt-3 text-[10px] text-gray-400 dark:text-slate-400 dark:text-slate-400 font-bold leading-relaxed">
