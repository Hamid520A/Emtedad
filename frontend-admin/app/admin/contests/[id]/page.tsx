          ...
          <div className="bg-white p-5 sm:p-6 rounded-2xl sm:rounded-[2.5rem] shadow-sm border border-gray-100 space-y-4 pt-6 sm:pt-8">
            ...
            {contest.video_url && getAparatEmbedUrl(contest.video_url) && (
              <div className="space-y-2 mt-2">
                <div className="w-full overflow-hidden rounded-xl sm:rounded-2xl shadow-sm border border-gray-100 bg-black aspect-video">
                  <iframe 
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="bg-[#1a2e44] text-[#c5a059] py-3 rounded-2xl text-xs font-black flex items-center justify-center gap-1.5 border border-gray-200 hover:bg-[#2a405a] transition active:scale-95 shadow-sm"
                  >
                  ...
                  <button
                    ...
                    className="bg-gray-100 text-gray-700 py-3 rounded-2xl text-xs font-black flex items-center justify-center gap-1.5 border border-gray-200 hover:bg-gray-200 transition active:scale-95 shadow-sm"
                  >
